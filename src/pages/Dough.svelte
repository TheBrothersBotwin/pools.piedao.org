<script>
    ...
    ethereum.sendAsync(
      {
        ...
        params: {
          ...
          options: {
            ...
            decimals: 18,
            image:
              'https://raw.githubusercontent.com/pie-dao/brand/master/DOUGH%20Token/DOUGH2v.png',
          },
        },
  ...
  $: (async () => {
    ...
    doughStaked =
      $farming['0xB9a4Bca06F14A982fcD14907D31DFACaDC8ff88E'].doughStaked.toFixed(2) || 0;
...
<Meta
  metadata={{
    title:
      'PieDAO DOUGH, the DAO governance token, managing DEFI index products and high APR staking rewards',
    description:
      "An overview of PieDAO's governance token DOUGH, the voting system, and the incentives mechanism.",
...
<div class="videocontainer">
  ...
  <div class="content flex flex-col spl px-4">
    <div
      class="text-24px font-bold text-lg leading-8 text-center mb-4"
      data-aos="fade-up"
      data-aos-delay="100"
    >
    ...
    />
    <div
      class="text-lg font-thin text-center mt-4 leading-8"
      data-aos="fade-up"
      data-aos-delay="200"
    >
      Contribute and be rewarded<br />for building a better organization and products.
    </div>
    <button
      class="items-center stakinggradient shake text-black text-left mt-20 md:mt-4 hover:opacity-80"
...
<a class="text-bold text-center mt-2 pointer" href="/#/dough-staking">
  <div class="flex flex-col items-center text-center mt-4 md:mt-10 mx-4 md:mx-8">
    <div
      class="flex flex-wrap justify-around w-full max-w-1240px bg-lightgrey rounded pb-12 px-8 md:px-10"
    >
